...
/////////////////
const BotName = 'FALL-BOTZ☄'; 
const instagram = 'https://instagram.com/mr_fall17'; 
const telegram = 'https://t.me/ギファル'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCaM0pPnpcvdSNchw0I8Dgyw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@mr_fall17')
